...
function Form() {
  ...
  function extractCountryCode(emoji) {
    if (
      typeof emoji === "object" &&
      emoji.type === "img" &&
      emoji.props &&
      ...
      const match = emoji.props.src.match(/\/([a-z]{2})\.png/);
      return match ? getFlagEmoji(match[1]) : null;
  ...
  async function handleSubmit(e) {
    ...
    const newCity = {
      cityName,
      country,
      emoji: extractCountryCode(emoji),
      date,
      notes,
      position: { lat, lng },
    };
